...
-- ----------------------------
INSERT INTO `hm_acl_resource` VALUES ('1', '首页', '', '', '1', '0', '1', '');
...
INSERT INTO `hm_acl_resource` VALUES ('6', '菜单设置', '2', '2', '1', '4', '2', '');
...
CREATE TABLE `hm_login_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=183 DEFAULT CHARSET=utf8 COMMENT='后台登陆日志表';
