...
-- ----------------------------
INSERT INTO `hm_acl_group` VALUES ('1', '超级管理员', '1', '1,2,4,5,6,13,14,15,7,8,9,10,22,23,11,19,20,21,16,17,24,18,25,12', '1', 'superadmin');
...
INSERT INTO `hm_acl_group` VALUES ('9', '新建角色', '1', '1,2,4,5,6,13,14,15,7,8,9,10,22,23,11,19,20,21,16,17,24,18,25,12', '11', 'xinjian');
...
INSERT INTO `hm_acl_resource` VALUES ('24', '删除一个月前登录日志', 'Site', 'delLoginLog', '1', '17', '1', '');
INSERT INTO `hm_acl_resource` VALUES ('25', '删除一个月前操作日志', 'Site', 'delOperateLog', '1', '18', '1', '');
...
CREATE TABLE `hm_login_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=198 DEFAULT CHARSET=utf8 COMMENT='后台登陆日志表';

-- ----------------------------
-- Records of hm_login_log
-- ----------------------------
INSERT INTO `hm_login_log` VALUES ('197', 'iteny', '1465475693', '192.168.0.185', '1', '密码保密', '对方和您在同一内部网', '局域网', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2693.2 Safari/537.36');
INSERT INTO `hm_login_log` VALUES ('196', 'iteny', '1465474906', '192.168.0.185', '1', '密码保密', '对方和您在同一内部网', '局域网', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2693.2 Safari/537.36');
INSERT INTO `hm_login_log` VALUES ('195', 'iteny', '1465474590', '192.168.0.185', '1', '密码保密', '对方和您在同一内部网', '局域网', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2693.2 Safari/537.36');
INSERT INTO `hm_login_log` VALUES ('194', 'iteny', '1465457693', '192.168.0.185', '1', '密码保密', '对方和您在同一内部网', '局域网', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2693.2 Safari/537.36');
...
INSERT INTO `hm_operate_log` VALUES ('91', 'asfd', '192.168.0.185', '1464271403', '局域网', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2693.2 Safari/537.36', '提示语：菜单排序成功\\n\\r模块：', 'http://sina.com/admin/site/menu', '1');
...
INSERT INTO `hm_operate_log` VALUES ('279', 'iteny', '192.168.0.185', '1465476637', '局域网', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2693.2 Safari/537.36', '提示语：添加菜单成功<br/>模块：admin,控制器：Site,方法：addEditMenu<br/>请求方式：Ajax', 'http://sina.com/admin/Site/addEditMenu/?pid=17', '1');
INSERT INTO `hm_operate_log` VALUES ('280', 'iteny', '192.168.0.185', '1465476683', '局域网', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2693.2 Safari/537.36', '提示语：添加菜单成功<br/>模块：admin,控制器：Site,方法：addEditMenu<br/>请求方式：Ajax', 'http://sina.com/admin/Site/addEditMenu/?pid=18', '1');
INSERT INTO `hm_operate_log` VALUES ('281', 'iteny', '192.168.0.185', '1465476700', '局域网', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2693.2 Safari/537.36', '提示语：授权成功<br/>模块：admin,控制器：Site,方法：setGroup<br/>请求方式：Ajax', 'http://sina.com/admin/Site/setGroup/?id=9', '1');
INSERT INTO `hm_operate_log` VALUES ('282', 'iteny', '192.168.0.185', '1465476718', '局域网', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2693.2 Safari/537.36', '提示语：授权成功<br/>模块：admin,控制器：Site,方法：setGroup<br/>请求方式：Ajax', 'http://sina.com/admin/Site/setGroup/?id=9', '1');
INSERT INTO `hm_operate_log` VALUES ('283', 'iteny', '192.168.0.185', '1465477015', '局域网', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2693.2 Safari/537.36', '提示语：删除登录日志成功！<br/>模块：admin,控制器：Site,方法：delLoginLog<br/>请求方式：Ajax', 'http://sina.com/admin/Site/loginLog', '1');
INSERT INTO `hm_operate_log` VALUES ('284', 'iteny', '192.168.0.185', '1465478191', '局域网', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2693.2 Safari/537.36', '提示语：删除登录日志成功！<br/>模块：admin,控制器：Site,方法：delLoginLog<br/>请求方式：Ajax', 'http://sina.com/admin/Site/operateLog?status=0&username=&loginip=&start_time=&end_time=', '1');
INSERT INTO `hm_operate_log` VALUES ('285', 'iteny', '192.168.0.185', '1465478266', '局域网', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2693.2 Safari/537.36', '提示语：删除登录日志成功！<br/>模块：admin,控制器：Site,方法：delLoginLog<br/>请求方式：Ajax', 'http://sina.com/admin/Site/operateLog', '1');
INSERT INTO `hm_operate_log` VALUES ('286', 'iteny', '192.168.0.185', '1465478302', '局域网', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2693.2 Safari/537.36', '提示语：删除操作日志成功！<br/>模块：admin,控制器：Site,方法：delOperateLog<br/>请求方式：Ajax', 'http://sina.com/admin/Site/operateLog', '1');
INSERT INTO `hm_operate_log` VALUES ('287', 'iteny', '192.168.0.185', '1465483042', '局域网', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2693.2 Safari/537.36', '提示语：修改系统设置成功<br/>模块：admin,控制器：Site,方法：set<br/>请求方式：Ajax', 'http://sina.com/admin/Site/set', '1');
INSERT INTO `hm_operate_log` VALUES ('288', 'iteny', '192.168.0.185', '1465483101', '局域网', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2693.2 Safari/537.36', '提示语：修改系统设置成功<br/>模块：admin,控制器：Site,方法：set<br/>请求方式：Ajax', 'http://sina.com/admin/Site/set', '1');
...
-- Records of hm_user
-- ----------------------------
INSERT INTO `hm_user` VALUES ('1', 'admin', '未知', 'ea42d19ad8d196fbbf861969dd92d5b3a02639ec', 'admin@abc3210.com', '备注信息', '1445067238', '192.168.0.1', '1');
