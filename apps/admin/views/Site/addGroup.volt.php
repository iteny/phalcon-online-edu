...
<body>
<div id="frame-top">
    当前位置&nbsp;<i class="iconfont" style="color:#666;font-size: 12px;">&#xe60e;</i>&nbsp;&nbsp;设置&nbsp;&nbsp;<i class="iconfont" style="color:#666;font-size: 12px;">&#xe60f;</i>&nbsp;&nbsp;用户设置&nbsp;&nbsp;<i class="iconfont" style="color:#666;font-size: 12px;">&#xe60f;</i>&nbsp;&nbsp;添加用户组
</div>
<div id="frame-toolbar">
    <ul>
        <li><a href="/admin/Site/group"><i class="iconfont" style="color:white;font-size: 16px;">&#xe611;</i>&nbsp;&nbsp;用户组管理</a></li>
        <li><a class="active" href="/admin/Site/addEditGroup"><i class="iconfont" style="color:white;font-size: 16px;">&#xe610;</i>&nbsp;&nbsp;添加用户组</a></li>
    </ul>
</div>
<div id="frame-content">
    <form name="addGroup" method="post" class="J_ajaxForm" action="/admin/Site/addEditGroup" novalidate="novalidate">
        ...
        <div class="frame-table-list">
            ...
            <table cellpadding="0" cellspacing="0" class="table_form" width="100%">
                ...
                <tr>
                    <td>用户组英文名:</td>
                    <td><input type="text" class="input length_5" name="role" id="role" value="">&nbsp;&nbsp;&nbsp;非常重要必须填写</td>
                </tr>
                <tr>
                    <td>是否启用:</td>
