    ...
    <form name="commonSort" class="ajax-form" action="/admin/Site/sortGroup" method="post">
        <div class="frame-table-list">
            <table width="100%">
                ...
                <tr>
                    <td align="center"><?php echo $this->escaper->escapeHtml($group['id']); ?></td>
                    <td align="left"><?php echo $this->escaper->escapeHtml($group['title']); ?></td>
                    <td align="center"><?php if ($group['status'] == 1) { ?><i class="iconfont" style="color:green;font-size: 16px;">&#xe60c;</i><?php } else { ?><i class="iconfont" style="color:red;font-size: 16px;">&#xe60a;</i><?php } ?></td>
                    <td align="center">
                        <?php if ($group['id'] == 1) { ?>
                        ...
                        <?php } else { ?>
                        <a class="ajax-add blue" href="/admin/Site/setGroup/?id=<?php echo $this->escaper->escapeHtml($group['id']); ?>" data-level="<?php echo $this->escaper->escapeHtml($menu['level']); ?>"><i class="iconfont" style="color:white;font-size: 16px;">&#xe610;</i>&nbsp;&nbsp;权限设置</a>&nbsp;&nbsp;&nbsp;<a class="ajax-edit blue" href="/admin/Site/addEditGroup/?id=<?php echo $this->escaper->escapeHtml($group['id']); ?>"><i class="iconfont" style="color:white;font-size: 16px;">&#xe615;</i>&nbsp;&nbsp;修改</a>&nbsp;&nbsp;&nbsp;<a class="ajax-del red" data-title="<?php echo $this->escaper->escapeHtml($group['title']); ?>" data-type="用户组" href="/admin/Site/delGroup" data-id="<?php echo $this->escaper->escapeHtml($group['id']); ?>"><i class="iconfont" style="color:white;font-size: 16px;">&#xe614;</i>&nbsp;&nbsp;删除</a>
                        <?php } ?>
                    </td>
                </tr>
                <?php } ?>
