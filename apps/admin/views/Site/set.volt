        ...
        <div class="frame-table-list">
            ...
            <table cellpadding="0" cellspacing="0" class="table_form" width="100%">
                ...
                <tr>
                    ...
                    <td><input type="radio" name="debug" value="true" {%if debug == true %}checked{% endif %}>启用<label>  &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="debug" value="false" {%if debug == false %}checked{% endif %}>禁止</label></td>
                </tr>
                <tr>
                    <td>redis默认缓存时间:</td>
                    <td><input type="text" class="input length_5" name="safecachetime" id="safecache" value="{{safecache}}"></td>
                </tr>
                <tr>
                    <td>后台菜单缓存:</td>
                    <td><input type="text" class="input length_5" name="adminmenu" id="adminmenu" value="{{adminmenu}}""></td>
                </tr>
                <tr>
                    <td>后台日志缓存:</td>
                    <td><input type="text" class="input length_5" name="adminlog" id="adminlog" value="{{adminlog}}""></td>
                </tr>
                </tbody>
            </table>
        </div>
