...
<div id="frame-content">
    <form name="editGroup" method="post" class="J_ajaxForm" action="/admin/Site/addEditGroup" novalidate="novalidate">
        ...
        <input type="hidden" name="id" value="{{thisgroup['id']}}">
        <div class="frame-table-list">
            ...
            <table cellpadding="0" cellspacing="0" class="table_form" width="100%">
                ...
                <tr>
                    ...
                    <td><input type="text" class="input length_5" name="title" value="{{thisgroup['title']}}" id="title"></td>
                </tr>
                <tr>
                    <td>用户组排序:</td>
                    <td><input type="text" class="input length_5" name="sort" id="sort" value="{{thisgroup['sort']}}"></td>
                </tr>
                <tr>
                    <td>用户组英文名:</td>
                    <td><input type="text" class="input length_5" name="role" id="role" value="{{thisgroup['role']}}">&nbsp;&nbsp;&nbsp;非常重要必须填写</td>
                </tr>
                <tr>
                    <td>是否启用:</td>
                    <td>
                        <input type="radio" name="status" value="1" {% if thisgroup['status'] == 1 %}checked{% endif %}>启用<label>  &nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio" name="status" value="0" {% if thisgroup['status'] == 0 %}checked{% endif %}>禁止</label></td>
                </tr>
                </tbody>
            </table>
        </div>
...
<script>
    ...
    var checkEditGtitle = '/admin/SiteCom/checkEditGtitle/?id='+{{thisgroup['id']}};
    var checkEditGrole = '/admin/SiteCom/checkEditGrole/?id='+{{thisgroup['id']}};
</script>
