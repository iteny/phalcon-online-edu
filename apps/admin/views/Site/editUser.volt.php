        ...
        <div class="frame-table-list">
            ...
            <table cellpadding="0" cellspacing="0" class="table_form" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <select name="group_id">
                            ...
                            <option value="<?php echo $group->id; ?>" <?php if ($group->id == $user['group_id']) { ?>selected<?php } ?>><?php echo $group->title; ?></option>
                            <?php } ?>
                        </select>
                    </td>
                </tr>
                <tr>
                    <td>是否启用:</td>
                    <td>
                        <input type="radio" name="status" value="1" <?php if ($user['status'] == 1) { ?>checked<?php } ?>>启用<label>  &nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio" name="status" value="0" <?php if ($user['status'] == 0) { ?>checked<?php } ?>>禁止</label></td>
                </tr>
                </tbody>
            </table>
        </div>
